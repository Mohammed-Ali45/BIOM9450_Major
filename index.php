...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    ...
    <span class="w3-large">Empowering researchers, oncologists, and genetic counselors in understanding and visualizing mutation variants in cancer patients.</span>
    <p><a href="about.php" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Learn more and start today</a></p>
  </div> 
...
<div class="w3-container w3-light-grey" style="padding:128px 16px">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      <h3>We know</h3>
      <p>"Welcome to CANCERICTIVE, where innovation meets compassion in our collective pursuit of understanding and visualizing mutation variants in cancer patients. Our platform is tailored for researchers, oncologists, and genetic counselors, providing a secure and intuitive space for advancing cancer research."</p>
...
<div class="w3-container w3-light-grey w3-padding-64">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      <h3>User Role</h3>
      <p>Join a diverse community of professionals! Explore CANCERICTIVE where researchers, oncologists, and genetic counselors collaborate seamlessly.</p>
